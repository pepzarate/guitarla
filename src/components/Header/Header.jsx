export const Header = ({ cart, removeFromCart, increaseQuantity, decreaseQuantity, emptyCart }) => {
                                                ...
                                                {cart.map( item => {
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td>{item.name}</td>
                                                            <td className="fw-bold">${item.price}
                                                            </td>
                                                            ...
                                                            <td>
                                                                <button onClick={() => removeFromCart(item.id)} className="btn btn-danger" type="button">X
                                                                </button>
                                                            </td>
                                                        </tr>
                                                    )
